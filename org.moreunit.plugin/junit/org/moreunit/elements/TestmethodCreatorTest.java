...
public class TestmethodCreatorTest extends ProjectTestCase {
	...
	public void testCreateTestMethod1_1() throws CoreException {
		...
		TestmethodCreator testmethodCreator = new TestmethodCreator(javaFileFacade.compilationUnit, PreferenceConstants.TEST_TYPE_VALUE_JUNIT_3);
	...
	public void testCreateTestMethod1_2() throws CoreException {
		...
		TestmethodCreator testmethodCreator = new TestmethodCreator(javaFileFacade.compilationUnit, PreferenceConstants.TEST_TYPE_VALUE_JUNIT_4);
		IMethod createdMethod = testmethodCreator.createTestMethod(method);
	...
	public void testCreateTestMethod2_1() throws CoreException {
		...
		TestmethodCreator testmethodCreator = new TestmethodCreator(testJavaFileFacade.compilationUnit, PreferenceConstants.TEST_TYPE_VALUE_JUNIT_3);
		IMethod createdMethod = testmethodCreator.createTestMethod(method);
	...
	public void testCreateTestMethod2_2() throws CoreException {
		...
		TestmethodCreator testmethodCreator = new TestmethodCreator(testJavaFileFacade.compilationUnit, PreferenceConstants.TEST_TYPE_VALUE_JUNIT_4);
		IMethod createdMethod = testmethodCreator.createTestMethod(method);
