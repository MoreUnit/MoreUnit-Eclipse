...
public class SourceFolderContext {
	...
	public List<IPackageFragmentRoot> getSourceFolderToSearch(IPackageFragmentRoot baseFolder) {
		...
		// if there are no settings for the project then take all source folder as context
		// you can not take the source folder for test because this method is used
