...
public class MoveMethodParticipant extends MoveParticipant
{
    ...
    public Change createChange(IProgressMonitor pm) throws CoreException, OperationCanceledException
    {
        ...
        // refactoringContribution.createDescriptor(id, project, description,
        // comment, arguments, flags)

        /*
         * IMethod testMethod =
         * javaFileFacade.getCorrespondingTestMethod(method); if(testMethod ==
         * null) return null; MoveProcessor moveProcessor = null;
